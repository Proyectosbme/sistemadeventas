...
@section('content_header')
    <h3 class="text-xl font-bold leading-none text-gray-900 dark:text-white">Editar Rol</h3>
    <hr>
@stop
    ...
    <div class="row mx-auto w-full">
        <div class="w-full p-4 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <div class="flex items-center justify-between mb-4">
                <h5 class="text-l font-bold leading-none text-gray-900 dark:text-white">Modifique los datos del rol</h5>
            </div>
            <hr>
            <div class="flow-root">
                    ...
                    <div class="grid gap-1 mb-3 md:grid-cols-1">
                        ...
                        <div>
                            <label for="name"
                                ...
                                del rol</label>
                            <input id="name" name="name" type="text" value="{{ old('name', $rol->name) }}"
                        ...
                        <div>
                            ...
                            <input id="description" name="description" type="text"
                                ...
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="Ingrese la description del rol..." required />
                                ...
                                <ul id="available-permissions"
                                    ...
                                    @foreach ($permissions as $permission)
                                        <li class="p-2 hover:bg-gray-100 cursor-pointer"
                                            ...
                                            @if (in_array($permission->id, $assignedPermissions)) style="display:none" @endif>
                                            {{ $permission->name }}
                                        </li>
                                    @endforeach
                                </ul>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function updatePermissionsInput() {
                ...
                permissionsInput.value = permissionIds.join(','); // Convertir a una cadena separada por comas
                console.log('Permisos seleccionados (actualizado):', permissionsInput.value); // Depuración
            }
            ...
            // Antes de enviar el formulario, asegurarse de que se actualicen los permisos seleccionados
            const form = document.querySelector('form');
            form.addEventListener('submit', (e) => {
                updatePermissionsInput();
                console.log('Permisos seleccionados (al enviar):', permissionsInput.value); // Depuración
            });

            // Inicializar el campo de permisos al cargar la página (para editar)
            updatePermissionsInput();
        });
    </script>
