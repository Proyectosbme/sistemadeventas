...
@section('content_header')
    <h3 class="text-xl font-bold leading-none text-gray-900 blue:text-white">Listado de Permisos</h3>
    <hr>
@stop
            ...
            <div class="w-full col-span-12 p-4 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                ...
                <div class="flow-root w-full">
                    <div class="flex items-center justify-between mb-4">
                        <h5 class="text-l font-bold leading-none text-gray-900 dark:text-white">Permisos registrados</h5>
                        <a href="{{ url('/admin/permisos/create') }}"
                    ...
                    <div class="relative overflow-x-auto shadow-md sm:rounded-lg w-full">
                        <table class="w-full text-sm text-center rtl:text-center text-gray-500 dark:text-gray-400">
                            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                <tr>
                                    <th scope="col" class="px-4 py-2">Nombre del permiso</th>
                            ...
                            <tbody>
                                @foreach ($permisos as $permiso)
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                        <td class="px-4 py-2 text-sm text-gray-900 dark:text-white">{{ $permiso->name }}</td>
                                        <td class="px-4 py-2 text-sm text-gray-900 dark:text-white">{{ $permiso->description }}</td>
                                        <td class="px-4 py-2 text-center">
                                            <div class="inline-flex" role="group">
                                                ...
                                                <script>
                                                    function preguntar(event, permisoId) {
                                                        ...
                                                        Swal.fire({
                                                            ...
                                                            if (result.isConfirmed) {
                                                                var form = document.getElementById('miFormulario' + permisoId);
                                                                form.submit();
                                                            }
                                                        });
                                                    }
