...
<x-general.titulo :titulo="'Editar de permisos'" :descripcion="'Gestiona los permisos en el sistema.'" />
@stop
        ...
        <div
            ...
            <form action="{{ route('admin.permisos.update', $permiso->id) }}" method="POST">
                ...
                <x-general.form-grid :columns="1">
                    <x-general.form-group label="Nombre del permiso" name="name" :value="old('name', $permiso->name)"
                        placeholder="Ingrese el nombre del permiso..." :required="true" :error="$errors->first('name')" />
                    <x-general.form-group-textarea label="Descripción del permiso" name="description" :value="old('description', $permiso->description)"
                        placeholder="Ingrese la descripción del permiso..." rows="3" :error="$errors->first('description')" />
                </x-general.form-grid>
