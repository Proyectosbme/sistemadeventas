...
<div class="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 py-4">
    ...
    <div class="flex flex-col justify-center space-y-2">
        <button type="button" class="add-all-items bg-blue text-white p-1 w-min rounded-full shadow hover:bg-blue-600 flex items-center justify-center">
            <x-heroicon-o-chevron-double-right class="h-4 w-4" />
        </button>
        <button type="button" class="add-item bg-blue text-white p-1 w-min rounded-full shadow hover:bg-blue-600 flex items-center justify-center">
            <x-heroicon-o-chevron-right class="h-4 w-4" />
        </button>
        <button type="button" class="remove-item bg-blue text-white p-1 w-min rounded-full shadow hover:bg-blue-600 flex items-center justify-center">
            <x-heroicon-o-chevron-left class="h-4 w-4" />
        </button>
        <button type="button" class="remove-all-items bg-blue text-white p-1 w-min rounded-full shadow hover:bg-blue-600 flex items-center justify-center">
